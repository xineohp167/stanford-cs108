...
public class MetropolisFrame extends JFrame {
	...
	public MetropolisFrame() {
		...
		populationPulldown = new JComboBox(new String[] { POPULATION_LARGER,
				POPULATION_SMALLER });
		matchTypePulldown = new JComboBox(new String[] { EXACT_MATCH,
				PARTIAL_MATCH });
	...
	private void addActionListeners() {
		...
		addButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				metropolisModel.add(metropolisField.getText(),
						continentField.getText(), populationField.getText());
		...
		searchButton.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				boolean larger = populationPulldown.getSelectedItem().equals(
						POPULATION_LARGER);
				boolean exact = matchTypePulldown.getSelectedItem().equals(
						EXACT_MATCH);
	...
	private void alignSideMenu() {
		...
		Dimension menuSize = new Dimension(
				matchTypePulldown.getMaximumSize().width,
